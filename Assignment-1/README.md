...
#### Solution:
[Evaluate Expression(1)](Prob2_Calc_exp.cpp)
...
#### Solution:
##### Part 1:
[Check Valid Statements](Prob3_Vowels.cpp)
...
##### Part 2:
[Evaluate expression(2)](Prob3_Pt2_evaluate.cpp)
...
#### Solution:
[Binary Representation](Prob4-Bin_rep.cpp)
